...
export type CheckoutMutation = {
  __typename?: "Mutation";
  checkout: { __typename?: "InitiateCheckout"; paymentKey: string };
};
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "checkoutProducts" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "paymentKey" } },
              ],
            },
          },
        ],
...
export const CreateProductsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateProducts" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
>;
export const FetchOrderDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FetchOrder" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "paymentKey" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                { kind: "Field", name: { kind: "Name", value: "priceTotal" } },
                {
                  kind: "Field",
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "priceUnit" },
                      },
                    ],
                  },
                },
...
} as unknown as DocumentNode<FetchOrderQuery, FetchOrderQueryVariables>;
